  ...
  return (
    <div className="container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          <label className="form-label">Ciudad de la sede principal de la empresa</label>
          <input
            type="text"
            className="form-control"
            name="ciudad"
        ...
        <div className="mb-3">
          <label className="form-label">Cuantos trabajadores tiene la empresa</label>
          <select
        ...
        <div className="mb-3">
          ...
          >
            <option value="">Seleccione una opción</option>
            <option value="demanda laboral">Contestar una demanda laboral</option>
            <option value="derecho de petición">Te presentaron un derecho de petición y/o tutela</option>
            <option value="contratos de trabajo">Asesoría en contratos de trabajo</option>
            <option value="asesoría laboral general">Asesoría laboral general</option>
            <option value="min trabajo">Proceso ante Min Trabajo</option>
            <option value="SST">Sistema de Gestión de SST</option>
            <option value="otra">Otra</option>
          </select>
          {errors.servicios && <p className="text-danger">{errors.servicios}</p>}
        </div>
